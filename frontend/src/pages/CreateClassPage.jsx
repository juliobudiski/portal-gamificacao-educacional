                    ...
                    <div className="relative p-8 z-10">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between">
                                <button
                                    type="submit"
                                    className="relative w-full sm:w-auto bg-gradient-to-r from-accent-yellow to-accent-teal text-primary-text font-bold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl hover:from-accent-yellow/90 hover:to-accent-teal/90 transform hover:-translate-y-0.5 transition-all duration-300 ease-out disabled:opacity-70 disabled:cursor-not-allowed group"
                                    disabled={isLoading}
                                >
