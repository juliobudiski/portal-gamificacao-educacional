...
function ActivityManagementPage() {
    ...
    if (loading) return <div className="text-center text-white p-10">Carregando atividades...</div>;
                                    ...
                                    <tr>
                                        <td colSpan="5" className="p-4 bg-gray-900/50">
                                            <div className="bg-gray-800 p-4 rounded-lg">
                                                <h4 className="font-bold text-white">Descrição:</h4>
                                                <p className="text-gray-300">{activity.description || 'Sem descrição.'}</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
