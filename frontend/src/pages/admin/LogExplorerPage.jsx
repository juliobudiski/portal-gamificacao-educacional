        ...
        <div className="animate-fade-in space-y-8 text-primary-text">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-accent-teal hover:bg-accent-teal/90 hover:-translate-y-1 hover:shadow-lg text-gray-900 font-bold rounded-lg shadow-md transition-all disabled:opacity-50"
                >
                    <Download size={20} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-primary-bg border border-border-color rounded-lg pl-10 pr-4 py-2 text-primary-text focus:ring-2 focus:ring-accent-teal outline-none transition-all shadow-inner hover:shadow-md"
                        />
                    </div>
                    <select
                        value={actionFilter}
                        onChange={(e) => setActionFilter(e.target.value)}
                        className="w-full bg-primary-bg border border-border-color rounded-lg px-4 py-2 text-primary-text focus:ring-2 focus:ring-accent-teal outline-none transition-all shadow-inner hover:shadow-md"
                    >
                    ...
                    <table className="min-w-full divide-y divide-border-color">
                        ...
                        <tbody className="divide-y divide-border-color">
                            {loading ? (
                                ...
                                logs.map(log => (
                                    <tr key={log.id} className="hover:bg-hover-bg-color0 transition-colors">
