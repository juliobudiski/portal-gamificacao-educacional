    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className={`text-3xl font-bold ${isUnlocked ? 'text-yellow-300' : 'text-gray-400'}`}>{medal.name}</h2>

                <p className="text-sm text-gray-400 mt-4 border-t border-gray-600 pt-4">
