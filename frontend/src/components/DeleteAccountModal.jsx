            ...
            <div className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        required
                        className="mt-1 block w-full px-4 py-3 bg-primary-bg border border-[#4a525a] text-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                ...
                <div className="flex justify-between gap-4 mt-6">
                    <button
                        onClick={onCancel}
                        className="w-full py-3 px-4 bg-gray-600 hover:bg-gray-700 text-primary-text font-semibold rounded-lg shadow-md transition-colors"
                    >
                        Cancelar
                    </button>
                    <button
