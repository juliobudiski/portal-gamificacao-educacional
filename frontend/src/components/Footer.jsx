...
function Footer() {
  ...
  return (
    <footer className="bg-[#2c3135] text-gray-300 text-sm border-t border-gray-700 shadow-xl">
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          {/* Texto legal */}
          <p className="max-w-3xl text-gray-400 leading-relaxed transition-colors duration-300 hover:text-gray-200">
